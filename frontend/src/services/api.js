...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || 'https://shambhavi-imitation-jewelry.onrender.com/api', // Fallback local: http://localhost:5000/api
  headers: {
    'Content-Type': 'application/json'
  },
  timeout: 10000 // 10 seconds network timeout boundary
});
